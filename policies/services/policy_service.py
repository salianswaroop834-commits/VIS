...
class PolicyService:
    ...
    def generate_policy_certificate(
        ...
        """
        from policies.services.certificate_service import PolicyCertificateService
    ...
    def request_policy_endorsement(
        ...
        from vehicles.models import UsageType
    ...
    def adjudicate_endorsement(
        ...
        """
        from service_requests.models import ServiceRequestStatus, ServiceRequestType
